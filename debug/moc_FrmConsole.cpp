/****************************************************************************
** Meta object code from reading C++ file 'FrmConsole.h'
**
** Created: Sun 19. Aug 22:36:27 2012
...
#error "The header file 'FrmConsole.h' doesn't include <QObject>."
...
const QMetaObject FrmConsole::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FrmConsole,
...
void *FrmConsole::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ISettingsProvider"))
        return static_cast< ISettingsProvider*>(const_cast< FrmConsole*>(this));
